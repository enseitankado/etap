...
SMARTDNS_CONF_HEADER = """# Generated by eta-kisit app.
...
def is_smartdns_conf_generated_by_eta_kisit():
    if not os.path.exists(SMARTDNS_CONF_PATH):
        return False

    with open(SMARTDNS_CONF_PATH, "r") as file1:
