...
# Ağ aralığı
AG_ARALIGI=$(/usr/bin/php8.4 /var/www/html/eta/disa-aktar.php IDARE_AG_ARALIGI)
CIKTI_DOSYASI="/var/www/html/eta/betikler/idare-agi-aktif-cihazlar.json"
GECMIS_DOSYASI="/var/www/html/eta/betikler/idare-agi-aktif-cihazlar-gecmisi.json"

echo "Ağ taraması başlatılıyor: $AG_ARALIGI"

# Ağ taraması (sessiz mod)
/usr/bin/nmap -e eth0 -sn "$AG_ARALIGI" > /dev/null
...
/usr/sbin/arp -an | /usr/bin/awk '/ether/ && $2 ~ /^[(]192\.168\./ {
    gsub(/[()]/, "", $2);
    print $2 " " $4
...
/usr/bin/php /var/www/html/eta/betikler/acik-kapali-ozetle.php /var/www/html/eta/betikler/idare-agi-aktif-cihazlar-gecmisi.json /var/www/html/eta/betikler/idare-agi-acik-kapali.json 300
