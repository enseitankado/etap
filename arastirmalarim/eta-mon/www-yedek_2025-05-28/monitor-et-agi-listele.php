<?php
  ...
  $envanter = json_decode(file_get_contents('et-envanter.json'), true);
  $aktifCihazlar = json_decode(file_get_contents('betikler/et-agi-aktif-cihazlar.json'), true);
    ...
    <div class="modal-dialog" id="macModalDialog">
        <div class="modal-content" style="height: 100%;">
            ...
            <div class="modal-body p-0">
                <iframe id="macModalIframe" src="" style="width:100%; height:100%; border:0;  overflow:auto;" scrolling="yes"></iframe>
            </div>
        </div>
    </div>
</div>
...
<div class="mt-3">
    <div class="alert alert-info d-flex justify-content-between align-items-center">
        <div>
			...
			<span class="badge bg-secondary ms-2">Son log: <?= htmlspecialchars($log_bilgi) ?></span>
        </div>
        <div><small class="text-muted">Ağ cihazları <?= $guncellemeMetni ?></small></div>
    </div>
</div>
